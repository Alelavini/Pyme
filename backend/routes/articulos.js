...
router.post("/api/articulos/", authenticateJWT, async (req, res) => {
  // #swagger.tags = ['Articulos']
...
router.put("/api/articulos/:id", authenticateJWT, async (req, res) => {
  // #swagger.tags = ['Articulos']
...
router.delete("/api/articulos/:id", authenticateJWT, async (req, res) => {
  // #swagger.tags = ['Articulos']
