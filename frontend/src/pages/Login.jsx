...
// Usuarios que crea el seed de la base de datos
const CUENTAS_DEMO = [
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.demo}>
          <p className={styles.demoTitle}>Cuentas demo</p>
          <div className={styles.demoList}>
            {CUENTAS_DEMO.map((c) => (
              <button
                ...
                onClick={() => setForm({ usuario: c.usuario, clave: c.clave })}
              >
                <strong>{c.usuario}</strong> / {c.clave}
